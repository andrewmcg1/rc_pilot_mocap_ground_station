...
private:
    ...
    {
        CStdStringA           oName;
        CStdStringA           eulerFirstAxis, eulerSecondAxis, eulerThirdAxis;
        unsigned int          nRGBColor;
...
public:
    ...
    const char*  Get6DOFBodyFirstEuler(unsigned int nBodyIndex);
    const char*  Get6DOFBodySecondEuler(unsigned int nBodyIndex);
    const char*  Get6DOFBodyThirdEuler(unsigned int nBodyIndex);
