...
int main(int argc, char** argv)
{
    ...
    std::string calibrationFile = getopt_get_string(gopt, kDeltaConfigPath);
    ...
    system("~/mocapserialrelay_delta/scripts/pin_config"); // Set up GPIO pins for XBee
    ...
    //////////////////////////////////////////////////////////////////////////////
    //                                                                          //
    //                CALIBRATE DELTA ARM TO RIGID BODY                         //
    //                                                                          //
    //////////////////////////////////////////////////////////////////////////////
    ...
    int microseconds = 20000; // 20ms = 50Hz
